...
const ButtonBar = ( { onCancel , showDelete, onDelete, saving, deleting} ) => 
<div className="btn-toolbar justify-content-between" role="toolbar" aria-label="Toolbar with button groups">
    ...
    <div className="btn-group  float-right" role="group" >
        ...
        <button type="submit" className="btn cpms-button">
            {saving &&
...
const DeleteButton = ({showDelete, onDelete, deleting}) => 
    <div className="btn-group" role="group" aria-label="Delete">
        {showDelete ?
         <button type="button" className="btn cpms-button" onClick={(id)=>onDelete(id)}>
            {deleting &&
            <div className="spinner-border text-secondary" role="status">
